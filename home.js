...
const mainItems = document.getElementById("items");
...
const leftTitleAreas = document.createElement("div");
leftTitleAreas.classList.add("titleAreas");

const RightTitleAreas = document.createElement("div");
